...
JobOrbit is a scalable professional networking platform built using a microservices architecture, supporting features like user profiles, connections, job postings, feeds, and real-time chat. The system is designed for modularity, scalability, and independent service deployment.
